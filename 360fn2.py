...
class MouseMoverApp:
    def __init__(self, master):
        ...
        self.key_label = tk.Label(master, text="Press 'u' to move the mouse for 365 degrees to the right")
        self.key_label.pack()
    ...
    def activate_mouse_move(self):
        ...
        # Przesunięcie myszki w prawo
        pyautogui.move(pixels_to_move_x, 0, duration=0.1)

    def move_mouse(self, e):
        self.key_label.config(text="Moving mouse to the right...")
        self.activate_mouse_move()
        self.key_label.config(text="Press 'u' to move the mouse for 365 degrees to the right")
